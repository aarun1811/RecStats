...
- [ ] **DATA-01**: Datasets list page colorized per global palette in both modes
...
- [ ] **DATA-05**: Any fixes/enhancements discovered in phase discuss are implemented and verified
