...
Plans:
- [ ] 02.1-01-PLAN.md -- Config-driven column mapping refactor for AG Charts + ECharts wrappers, error panels, theme overrides
...
| 02.1. Chart Rendering Foundation | 0/3 | Planning complete | - |
