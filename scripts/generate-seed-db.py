...
def generate_bank(conn: sqlite3.Connection, target: int = 200) -> list[tuple[str, str, str]]:
...
def generate_message_feed(conn: sqlite3.Connection, bank_rows: list, target: int = 500) -> list[tuple[str, str]]:
...
def generate_items(conn: sqlite3.Connection, corr_accounts: list[str], target: int = 5_000) -> None:
...
def generate_tlm_headers(conn: sqlite3.Connection, corr_accounts: list[str], target: int = 4_000) -> None:
...
def generate_manual_match_stats(conn: sqlite3.Connection, target: int = 2_000) -> None:
