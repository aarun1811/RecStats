...
SAMPLE_DASHBOARDS = [
    {
        ...
        "layout": {
            ...
            "widgets": [
                ...
                {"id": "w7", "type": "chart", "x": 0, "y": 6, "cols": 4, "rows": 4, "title": "Volume by Region", "chartId": "chart-exec-region-bar", "chartType": "bar"},
                {"id": "w8", "type": "chart", "x": 4, "y": 6, "cols": 4, "rows": 4, "title": "Status Distribution", "chartId": "chart-exec-status-donut", "chartType": "donut"},
                {"id": "w9", "type": "chart", "x": 8, "y": 6, "cols": 4, "rows": 4, "title": "LOB Match Rates", "chartId": "chart-radialbar-lob", "chartType": "radialBar"},
                {"id": "w10", "type": "table", "x": 0, "y": 10, "cols": 12, "rows": 5, "title": "Recent Transactions", "sql": "SELECT id, date, amount, currency, region, lob, source_system, status FROM transactions ORDER BY date DESC LIMIT 15", "config": {}},
            ]
        },
        "filters": None,
    },
    {
        ...
        "layout": {
            ...
            "widgets": [
                ...
                {"id": "w7", "type": "chart", "x": 0, "y": 6, "cols": 6, "rows": 4, "title": "Amount vs Age Analysis", "chartId": "chart-scatter-amount-age", "chartType": "scatter"},
    ...
    },
    {
        ...
        "layout": {
            ...
            "widgets": [
                ...
                {"id": "w5", "type": "chart", "x": 0, "y": 2, "cols": 6, "rows": 5, "title": "Regional Volume Treemap", "chartId": "chart-treemap-region", "chartType": "treemap"},
                {"id": "w6", "type": "chart", "x": 6, "y": 2, "cols": 6, "rows": 5, "title": "Regional Performance", "chartId": "chart-radar-region", "chartType": "radar"},
                {"id": "w7", "type": "chart", "x": 0, "y": 7, "cols": 6, "rows": 4, "title": "Transactions by Region", "chartId": "chart-geo-region", "chartType": "bar"},
                {"id": "w8", "type": "chart", "x": 6, "y": 7, "cols": 6, "rows": 4, "title": "Country Treemap", "chartId": "chart-treemap-country", "chartType": "treemap"},
                {"id": "w9", "type": "table", "x": 0, "y": 11, "cols": 12, "rows": 5, "title": "Top Countries by Volume", "sql": "SELECT country, region, COUNT(*) as transactions, ROUND(AVG(amount), 2) as avg_amount, COUNT(DISTINCT counterparty) as counterparties FROM transactions GROUP BY country, region ORDER BY transactions DESC LIMIT 15", "config": {}},
            ]
        },
        "filters": None,
    },
    {
        ...
        "layout": {
            ...
            "widgets": [
                ...
                {"id": "w4", "type": "chart", "x": 0, "y": 2, "cols": 6, "rows": 5, "title": "Processing Funnel", "chartId": "chart-funnel-processing", "chartType": "funnel"},
                {"id": "w5", "type": "chart", "x": 6, "y": 2, "cols": 6, "rows": 5, "title": "System Match Rates", "chartId": "chart-radialbar-system", "chartType": "radialBar"},
                {"id": "w6", "type": "chart", "x": 0, "y": 7, "cols": 6, "rows": 4, "title": "Volume by Source System", "chartId": "chart-recon-by-system", "chartType": "bar"},
                {"id": "w7", "type": "chart", "x": 6, "y": 7, "cols": 6, "rows": 4, "title": "Match Rate by System", "chartId": "chart-recon-match-rate", "chartType": "bar"},
                {"id": "w8", "type": "table", "x": 0, "y": 11, "cols": 12, "rows": 5, "title": "Recent Unmatched Transactions", "sql": "SELECT id, date, amount, currency, region, lob, source_system, counterparty, status FROM transactions WHERE status IN ('unmatched', 'break') ORDER BY date DESC LIMIT 25", "config": {}},
            ]
        },
        "filters": None,
    },
    {
        ...
        "layout": {
            ...
            "widgets": [
                ...
                {"id": "w4", "type": "chart", "x": 0, "y": 2, "cols": 8, "rows": 4, "title": "Weekly Transaction Volume", "chartId": "chart-trend-weekly", "chartType": "line"},
                {"id": "w5", "type": "chart", "x": 8, "y": 2, "cols": 4, "rows": 4, "title": "Volume vs Breaks", "chartId": "chart-scatter-volume-breaks", "chartType": "scatter"},
                {"id": "w6", "type": "chart", "x": 0, "y": 6, "cols": 6, "rows": 4, "title": "Matched Transactions Area", "chartId": "chart-area-matched", "chartType": "area"},
                {"id": "w7", "type": "chart", "x": 6, "y": 6, "cols": 6, "rows": 4, "title": "Daily Breaks Trend", "chartId": "chart-trend-breaks", "chartType": "line"},
                {"id": "w8", "type": "table", "x": 0, "y": 10, "cols": 12, "rows": 5, "title": "Daily Metrics History", "sql": "SELECT date, total_transactions, matched, unmatched, breaks, match_rate, avg_break_age FROM daily_metrics ORDER BY date DESC LIMIT 14", "config": {}},
            ]
        },
        "filters": None,
    },
